...
def tlisensi():
	...
	if kall in ['']:
	    ...
	    os.system("xdg-open https://wa.me/2348167676589?text=HACKPRO+bang+gw+mau+beli+lisensi")
	    tlisensi()
	elif kall in ['trial','TRIAL']:
	     os.system("xdg-open https://wa.me/2348167676589?text=HACKPRO+bang+gw+mau+trial+lisensi")
	     tlisensi()	 
